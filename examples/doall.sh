...
#$SF 2021_pan37.tif 2021_pan37sf.tif -fsr -hy .48 -CIE 6 -df 1.0 -nf 0.5 -sx -55 -sy .825 -C .29 -D -9.3 -F 3.5 -G 1.0 -O G sl sd -sm 300 1000 -rm 457 794 -tol 5 .3 .08 $FHML $FLAGS $1 $2

#$SF 2021_ShoshonePt.tif 2021_ShoshonePtsf2.tif $FHML -tol 360 .3 .03 -O sd -fs 1.0 -df 0.9 $FLAGS $1 

$SF DSC03507-DSC03512.tif DSC03507-DSC03512sf.tif $FHML -fsh 0.65 1.0 -tol 360 .3 .03 $FLAGS $1
