...
int get_sky_mean_var(tdata_t *image, int x, int y0, int n, float mean[], float var[]) ;
...
int find_end_of_sky(int16_t *end_of_sky,int16_t *start_of_sky,int w,int h,tdata_t *image,int fix_edges,int fix_slivers, SKYFILL_DATA_t *pData) ;
int test_find_end_of_sky(int16_t *end_of_sky,int16_t *start_of_sky,int w,int h,tdata_t *image,int fix_edges,int fix_slivers, SKYFILL_DATA_t *pData) ;
#endif
